...
def migrate_db():
    ...
    migrations = [
        ...
        """CREATE TABLE IF NOT EXISTS mock_exams (
            ...
            confidence_enabled  INTEGER DEFAULT 1,
            instant_performance_view INTEGER DEFAULT 1,
            created_by          INTEGER REFERENCES users(id),
            created_at          DATETIME DEFAULT CURRENT_TIMESTAMP
        )""",
        ...
        """ALTER TABLE mock_exams ADD COLUMN question_set TEXT""",
        """ALTER TABLE mock_exams ADD COLUMN shuffle_questions INTEGER DEFAULT 1""",
